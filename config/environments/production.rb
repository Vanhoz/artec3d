...
Rails.application.configure do
  # Settings specified here will take precedence those in config/application.rb.
  ...
  # has been available in either ENV["RAILS_MASTER_KEY"]
  ...
  # config.active_job.queue_name_prefix = "artec3d_#{Rails.env}"
